...
$database = "u870763007_btcj";
$username = "u870763007_root";
$password = "TcWdBG3fN2";
global $cxn;
...
class Sql {
    ...
    public function update($regs = array(), $cont = null) {
        $this->type = 'update';
        if (!is_array($regs) && $cont != null) {
...
//    public function join($type = 'left', $table, $name) {
...
//    }
//    
//    public function on($field1,$field2,$criteria){
//        $table = end($this->join);
//        $this->join[$table][];
//    }
